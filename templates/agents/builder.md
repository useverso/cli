...
## CLI Commands for Builders

When your build fails or encounters issues:
- `verso build fail <id> --reason "describe the failure"`

When you create a PR and CI passes:
- `verso review start <id>`

To check current item state:
- `verso board show <id>`
