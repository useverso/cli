...
## CLI Commands for Reviewers

After completing your review:
- Approve: `verso review submit <id> --verdict approve --summary "LGTM — all criteria met"`
- Request changes: `verso review submit <id> --verdict request-changes --summary "describe issues"`

If max review rounds exceeded and issues persist:
- `verso review escalate <id>`

To check the item being reviewed:
- `verso board show <id>`

IMPORTANT: Never edit .verso/board.yaml directly. Use `verso` commands.
